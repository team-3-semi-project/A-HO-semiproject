...
public class AhoUserDTO implements Serializable {
	...
	/*
	 * public AhoUserDTO(int code, int vipCode, String id, String pw, String name,
	 * String email, String phone, Date birth, String gender, int point, Date
	 * joinDate, Date outDate, String outYN, String blackListYN, String
	 * blackListReason, String grade, List<ReserveAndReportDTO> reserve) { this.code
	 * = code; this.vipCode = vipCode; this.id = id; this.pw = pw; this.name = name;
	 * this.email = email; this.phone = phone; this.birth = birth; this.gender =
	 * gender; this.point = point; this.joinDate = joinDate; this.outDate = outDate;
	 * this.outYN = outYN; this.blackListYN = blackListYN; this.blackListReason =
	 * blackListReason; this.grade = grade; this.reserve = reserve; }
	 * 
	 * public int getCode() { return code; }
	 * 
	 * public void setCode(int code) { this.code = code; }
	 * 
	 * public int getVipCode() { return vipCode; }
	 * 
	 * public void setVipCode(int vipCode) { this.vipCode = vipCode; }
	 * 
	 ...
	 * 
	 * public String getOutYN() { return outYN; }
	 * 
	 * public void setOutYN(String outYN) { this.outYN = outYN; }
	 * 
	 * public String getBlackListYN() { return blackListYN; }
	 * 
	 * public void setBlackListYN(String blackListYN) { this.blackListYN =
	 * blackListYN; }
	 * 
	 * public String getBlackListReason() { return blackListReason; }
	 * 
	 * public void setBlackListReason(String blackListReason) { this.blackListReason
	 * = blackListReason; }
	 * 
	 ...
	 * 
	 * public List<ReserveAndReportDTO> getReserve() { return reserve; }
	 * 
	 * public void setReserve(List<ReserveAndReportDTO> reserve) { this.reserve =
	 * reserve; }
	 * 
	 * public static long getSerialversionuid() { return serialVersionUID; }
	 * 
	 * @Override public String toString() { return "AhoUserDTO [code=" + code +
	 * ", vipCode=" + vipCode + ", id=" + id + ", pw=" + pw + ", name=" + name +
	 * ", email=" + email + ", phone=" + phone + ", birth=" + birth + ", gender=" +
	 * gender + ", point=" + point + ", joinDate=" + joinDate + ", outDate=" +
	 * outDate + ", outYN=" + outYN + ", blackListYN=" + blackListYN +
	 * ", blackListReason=" + blackListReason + ", grade=" + grade + ", reserve=" +
	 * reserve + "]"; }
	 */
