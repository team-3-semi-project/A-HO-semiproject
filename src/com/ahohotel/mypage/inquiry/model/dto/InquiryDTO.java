...
public class InquiryDTO implements Serializable {
	...
	public InquiryDTO(int inquiryCode, int rowNum, int userCode, String inquiryTitle, String inquiryContent,
			String inquiryAnswer, Date inquiryDate, String inquiryCategory, String userId,
			List<InquiryFileDTO> inquiryFileList) {
	...
	public String toString() {
		return "InquiryDTO [inquiryCode=" + inquiryCode + ", rowNum=" + rowNum + ", userCode=" + userCode
				...
				+ inquiryAnswer + ", inquiryDate=" + inquiryDate + ", inquiryCategory=" + inquiryCategory + ", userId="
				+ userId + ", inquiryFileList=" + inquiryFileList + "]";
	}
