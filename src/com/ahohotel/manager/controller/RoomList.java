...
public class RoomList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totalCount = roomService.selectRoomTotalCount(searchMap);
		...
		/* 조회해온다 */
		List<RoomListDTO> roomList = roomService.selectRoomList(selectCriteria);
		
		System.out.println("roomList : " + roomList);
		
		String path = "";
		if(roomList != null) {
			path = "/WEB-INF/view/manager/roomlist.jsp";
