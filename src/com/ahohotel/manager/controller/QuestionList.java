...
@WebServlet("/manager/questionlist")
public class QuestionList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		searchMap.put("noanswer", noanswer);
		...
		int totalCount = questionService.selectQuestionTotalCount(searchMap);
		...
		if(noanswer != null && !"".equals(noanswer)) {
			selectCriteria.setNoAnswer(noanswer);
		}
		
		System.out.println(selectCriteria);
		
		/* 조회해온다 */
		List<InquiryDTO> questiontList = questionService.selectQuestionList(selectCriteria);
		
		System.out.println("reportList : " + questiontList);
		
		String path = "";
		if(questiontList != null) {
			path = "/WEB-INF/view/manager/questionlist.jsp";
			request.setAttribute("questionList", questiontList);
