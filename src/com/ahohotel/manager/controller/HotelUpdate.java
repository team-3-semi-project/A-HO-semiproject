...
@WebServlet("/manager/hotelupdate")
public class HotelUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HotelListDTO hotel = hotelService.selectHotel(code);
		
		System.out.println(hotel);
		
		request.setAttribute("hotel", hotel);
		request.getRequestDispatcher("/WEB-INF/view/manager/hotelupdate.jsp").forward(request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(ServletFileUpload.isMultipartContent(request)) {
			...
			String fileUploadDirectory = rootLocation + "/resources/hotel-img/";
			String thumbnailDirectory = rootLocation + "/resources/hotelthum/";
...
//						parameter.put(item.getFieldName(), item.getString());
				...
				HotelListDTO thumbnail = new HotelListDTO();
				thumbnail.setHotelCode(Integer.valueOf(parameter.get("hotelCode")));
				thumbnail.setHotelName(parameter.get("hotelName"));
				thumbnail.setHotelStar(parameter.get("hotelStar"));
				thumbnail.setHotelPhone(parameter.get("hotelPhone"));
				thumbnail.setHotelAddress(parameter.get("hotelAddress"));
				thumbnail.setHotelOpen(parameter.get("hotelOpen"));
				thumbnail.setCheckIn(parameter.get("checkIn"));
				thumbnail.setCheckOut(parameter.get("checkOut"));
				thumbnail.setIntroduce(parameter.get("introduce")); 
				thumbnail.setLatitude(Double.valueOf(parameter.get("latitude")));
				thumbnail.setLongitude(Double.valueOf(parameter.get("longitude"))); 
				
				thumbnail.setHotelPhoto(new ArrayList<HotelPhotoDTO>());
				List<HotelPhotoDTO> list = thumbnail.getHotelPhoto();
				for(int i = 0; i < fileList.size(); i++) {
