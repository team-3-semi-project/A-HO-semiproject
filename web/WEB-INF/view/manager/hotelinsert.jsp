...
<body>
	...
	<section id="maindiv" class="userdetail col-md-auto ml-sm-auto col-lg-7 px-md-4" style="padding-top: 10px !important;">
			<form action="${ pageContext.servletContext.contextPath }/manager/hotelinsert" id="insertform" method="post" encType="multipart/form-data">
				<button class="btn btn-outline-dark" style="float: right;">등록하기</button>
            	<h2 class="text-center">호텔 등록</h2>
            	<hr>
            
            <article id="hotelInsert">
            		<div id="img">
            			<h4>대표 이미지</h4>
            			<div id="main-img">
            				<img id="titleImg" width="400" height="250">
            			</div>
            			<div id="else-img1">
            				<img id="contentImg1" width="115" height="70">
            			</div>
            			<div id="else-img2">
            				<img id="contentImg2" width="115" height="70">
            			</div>	
            			<div id="else-img3">
            				<img id="contentImg3" width="115" height="70">
            			</div>
            		...
            		<div id="infoForm" style="margin-left: 20px">
            			<p class="m-0">호텔명</p>
	                    <input required="required" type="text" name="hotelName">
	                    <p class="m-0">호텔 등급</p>
	                    <input required="required" name="hotelStar">
	                    <p class="m-0">연락처</p>
	                    <input required="required" name="hotelPhone">
	                    <p class="m-0">주소</p>
	                    <input required="required" name="hotelAddress">
	                    <p class="m-0">운영 여부</p>
	                    <input required="required" name="hotelOpen">
	                    <p class="m-0">체크인</p>
	                    <input required="required" name="checkIn">
	                    <p class="m-0">체크아웃</p>
	                    <input required="required" name="checkOut">
	                    <p class="m-0">위도</p>
	                    <input required="required" name="latitude">
	                    <p class="m-0">경도</p>
	                    <input required="required" name="longitude">
	                    <p class="m-0">호텔 소개</p>
	                    <textarea form="insertform" name="introduce" required="required" ></textarea>
            		</div>
                </form>
            </article>
        </section>
