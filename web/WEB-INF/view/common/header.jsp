        ...
        <div class="row flex-nowrap justify-content-between align-items-center">
          ...
          <div class="col-4 d-flex justify-content-end align-items-center" >
            ...
            <c:if test="${ empty sessionScope.loginUser }">
            	<a class="btn btn-outline-secondary" href="${ pageContext.servletContext.contextPath }/user/login">로그인</a> &nbsp;
            	<a class="btn btn-outline-secondary" href="${ pageContext.servletContext.contextPath }/user/signup">회원가입</a>
            </c:if>
            <c:if test="${ !empty sessionScope.loginUser }">
